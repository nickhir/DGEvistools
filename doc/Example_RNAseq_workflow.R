...
## ---- warning=F, message=F, fig.width =5.8, fig.height=3.8--------------------
library(DESeq2)
...
## ----volcano plot, fig.width=7.1, fig.height=4--------------------------------
...
## ----correlation plot, fig.width=7.36, fig.height=4.6-------------------------
...
## ----boxplots, fig.width=7.3, fig.height=3.5----------------------------------
...
## ----WGCNA, fig.width=6.3, fig.height=4---------------------------------------
library(GWENA)
...
## ----module association, fig.width=8.3, fig.height=4.2------------------------
library(ggpubr)
